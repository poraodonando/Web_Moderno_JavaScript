 ...
 * de cédulas para um determinado valor informado pelo usuário considerando notas de 
 * R$ 100, R$ 50, R$ 10 e R$ 5 e R$ 1.
 * Seu programa deve mostrar apenas as notas utilizadas. Por exemplo, ao solicitar 
 * R$18, o programa deve informar apenas a seguinte informação 
...
function contaNotas(valor){
    ...
    let n100 = 0, n50 = 0, n10 = 0, n5 = 0, n1 = 0;
        ...
        if(valor > 100){
            n100 = valor/100 - valor/10 ; 
        }



        return console.log(n100);
